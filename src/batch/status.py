...
class ProcessingStatus:
    ...
    state: (
        State  # state of the file processing, take a value among ProcessingStatus.State (mutable)
    )
    ...
    _isUpdated: (
        bool  # indicates if ProcessingStatus has been modified since its creation or its retrieval
    )
    ...
    @classmethod
    def getAllFromStore(
        cls: "ProcessingStatus", store: "DictStore"
