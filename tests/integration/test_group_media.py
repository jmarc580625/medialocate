...
class TestGroupMediaCommand(unittest.TestCase):
    ...
    def test_group_media_with_default_args(self):
        ...
        with open(self.location_store, 'w') as f:
            f.write('{"media1.jpg": {"gps":{"latitude": 48.8584, "longitude": 2.2945}}}')
    ...
    def test_group_media_without_force_flag(self):
        ...
        self.assertEqual(final_mtime, initial_mtime, "Groups file should not have been regenerated")
    ...
    def test_group_media_with_force_flag(self):
        ...
        # Verify the file was actually regenerated
        final_mtime = os.path.getmtime(self.groups_store)
        self.assertGreater(final_mtime, initial_mtime, "Groups file should have been regenerated")
    ...
    def test_group_media_with_multiple_directories(self):
        ...
        data = {
            ...
            "media2.jpg": {"gps": {"latitude": 48.8583, "longitude": 2.2946}}   # Near location 1
        }
        ...
        # Check dir1 groups
        for directory in [dir1, dir2]:
            groups_file = os.path.join(directory, MEDIALOCATION_DIR, MEDIAGROUPS_STORE_NAME)
            self.assertTrue(os.path.exists(groups_file), f"{directory} should have its own groups file")
            with open(groups_file, 'r') as f:
                dir_groups = json.load(f)
                # Verify media are grouped together (since they're close)
                self.assertTrue(sorted(dir_groups["groups"][0]["media_keys"]) == sorted(["media1.jpg", "media2.jpg"]),
